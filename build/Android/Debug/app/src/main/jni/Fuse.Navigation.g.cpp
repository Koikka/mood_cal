...
static void RouterCancelNavigation_build(uType* type)
{
    ...
    ::STRINGS[35] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.8.1/RouterCancelNavigation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Navigation::Router_typeof());
    type->SetFields(8,
...
void RouterModify::PerformRoute(::g::Fuse::Node* n, ::g::Fuse::Navigation::RouterPageRoute* route)
{
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[34/*"Router not ...*/], this, uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.8.1/RouterModify.uno"), 216, uString::Const("PerformRoute"), NULL);
        return;
    }
...
static void RouterPageRoute_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.8.1/RouterPage.uno");
...
static void FindRouter__Subscription_build(uType* type)
{
    ...
    ::STRINGS[48] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.8.1/FindRouter.uno");
...
static void SwipeNavigate_build(uType* type)
{
    ...
    ::STRINGS[51] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.8.1/SwipeNavigate.uno");
...
static void VisualNavigation_build(uType* type)
{
    ...
    ::STRINGS[56] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.8.1/VisualNavigation.uno");
...
static void WhileNavigating_build(uType* type)
{
    ...
    ::STRINGS[59] = uString::Const("/usr/local/share/uno/Packages/Fuse.Navigation/1.8.1/WhileNavigating.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[48] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    type->SetDependencies(
