...
#include <Fuse.Elements.Element-5a961b88.h>
...
#include <Fuse.Elements.NoImpli-95e535b7.h>
#include <Fuse.Elements.Optiona-911492a3.h>
#include <Fuse.Elements.Perspec-79d80e60.h>
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Enums.uno
// -----------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Element.Transform.uno
// -----------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/AspectBoxSizing.uno
// ---------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/BoxSizing.uno
// ---------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Element.Layout.uno
// --------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Caching/Cache.Heuristic.uno
// -----------------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Caching/Cache.uno
// -------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Caching/ElementAtlasPool.uno
// ------------------------------------------------------------------------------------------------------------------------------------------------------
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Draw called on a non-rooted node"), __this, uString::Const("/Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Element.Drawing.uno"), 67, uString::Const("Draw"));
...
void Element__OnArrangeMarginBox_fn(Element* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    if (bp.SanityConstrain())
    {
        if (!Element::_invalidValuesWarn_)
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid values in ArrangeMarginBox"), __this, uString::Const("/Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Element.Layout.uno"), 262, uString::Const("OnArrangeMarginBox"));
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log3(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("CaptureRegion bigger than maximum texture size, dropping rendering (size: "), uBox(::g::Uno::Int2_typeof(), fsz)), uString::Const(", max-size: ")), uBox<int32_t>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 0, uString::Const("node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Element.Drawing.uno"), 40);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("This element can not be drawn."), this, uString::Const("/Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Element.Effects.uno"), 125, uString::Const("Composit"));
    }
}
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Caching/ElementAtlas.uno
// --------------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Caching/ElementBatch.uno
// --------------------------------------------------------------------------------------------------------------------------------------------------
...
static void ElementBatch_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(ElementBatch, _draw_b9458d08), 0);
}
...
{
    _draw_b9458d08 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseElements_bundle::ElementBatch016550d8());
}
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Caching/ElementBatcher.uno
// ----------------------------------------------------------------------------------------------------------------------------------------------------
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Caching/ElementBatcher.uno");
        ...
        {
            {
                while (enum4.MoveNext(::TYPES[19/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]))
                {
                    ...
                    if (emitNewBatch || (atlas == NULL))
                    {
                        ...
                        {
                            ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[11/*"BUG: atlas-...*/], 0, ::STRINGS[12/*"node_module...*/], 253);
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/LayoutFunctions.uno
// ---------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Element.HitTest.uno
// ---------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/InteractiveTransform.uno
// --------------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Element.ITreeRenderer.uno
// ---------------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/LayoutMasterBoxSizing.uno
// ---------------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/LimitBoxSizing.uno
// --------------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/Transforms.uno
// ----------------------------------------------------------------------------------------------------------------------------------------
...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Controls/1.12.0/Viewport.uno
// --------------------------------------------------------------------------------------------------------------------------------------
...
static void LayoutFunction__Subscription_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Elements/1.12.0/LayoutFunctions.uno");
...
void LayoutFunction__Subscription__OnNewData_fn(LayoutFunction__Subscription* __this, uObject* source, uObject* elmObj)
{
    ...
    ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[16/*"Invalid val...*/], elmObj), __this, ::STRINGS[17/*"/Users/antt...*/], 75, ::STRINGS[18/*"OnNewData"*/], NULL);
    ::g::Fuse::Reactive::IListener::OnLostData(uInterface(uPtr(__this->_listener), ::TYPES[29/*Fuse.Reactive.IListener*/]), (uObject*)__this->_lf);
}
...
static void Viewport_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::TYPES[32/*Fuse.ICommonViewport*/], offsetof(Viewport_type, interface20));
    type->SetFields(103,
        ...
        ::g::Fuse::IFrustum_typeof(), offsetof(Viewport, _frustum), 0,
...
void Viewport__DrawWithChildren_fn(Viewport* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (__this->Mode() == 2)
    {
        ::g::Uno::Float2 pxSize = ::g::Fuse::ICommonViewport::PixelSize(uInterface((uObject*)__this, ::TYPES[32/*Fuse.ICommonViewport*/]));
...
{
    return *__retval = __this->IsDisabled() ? ::g::Fuse::ICommonViewport::PixelSize(uInterface(uPtr(uPtr(__this->Parent())->Viewport()), ::TYPES[32/*Fuse.ICommonViewport*/])) : ::g::Uno::Float2__op_Multiply1(__this->ActualSize(), ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface((uObject*)__this, ::TYPES[32/*Fuse.ICommonViewport*/]))), void();
}
...
{
    return *__retval = ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(uPtr(__this->Parent())->Viewport()), ::TYPES[32/*Fuse.ICommonViewport*/])), void();
}
...
{
    return *__retval = __this->IsDisabled() ? ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(uPtr(__this->Parent())->Viewport()), ::TYPES[32/*Fuse.ICommonViewport*/])) : __this->ActualSize(), void();
}
...
void Viewport__OnRooted_fn(Viewport* __this)
{
    ...
    __this->add_Placed(uDelegate::New(::TYPES[25/*Fuse.PlacedHandler*/], (void*)Viewport__OnPlaced_fn, __this));
}

// protected override sealed void OnUnrooted()
void Viewport__OnUnrooted_fn(Viewport* __this)
{
    __this->remove_Placed(uDelegate::New(::TYPES[25/*Fuse.PlacedHandler*/], (void*)Viewport__OnPlaced_fn, __this));
