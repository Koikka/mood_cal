...
static void Hamburger_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("Hamburger.ux");
    ::STRINGS[5] = uString::Const("IsOpen");
    ...
    type->SetDependencies(
        ...
        ::g::Kalenteri_accessor_Hamburger_IsOpen_typeof());
    type->SetInterfaces(
...
void Hamburger::InitializeUX()
{
    ...
    temp_Value_inst = ::g::Kalenteri_FuseTriggersWhileBool_Value_Property::New1(temp, Hamburger::__selector0_);
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::Kalenteri_accessor_Hamburger_IsOpen::Singleton());
    ...
    SourceLineNumber(1);
    SourceFileName(::STRINGS[4/*"Hamburger.ux"*/]);
    temp->SourceLineNumber(4);
    temp->SourceFileName(::STRINGS[4/*"Hamburger.ux"*/]);
    ...
    temp2->SourceFileName(::STRINGS[4/*"Hamburger.ux"*/]);
    temp1->SourceLineNumber(4);
    temp1->SourceFileName(::STRINGS[4/*"Hamburger.ux"*/]);
    temp9->ItemSpacing(4.0f);
    temp9->Width(::g::Uno::UX::Size__New1(25.0f, 1));
    temp9->Alignment(8);
    temp9->SourceLineNumber(14);
    temp9->SourceFileName(::STRINGS[4/*"Hamburger.ux"*/]);
    ...
    uPtr(top)->SourceLineNumber(15);
    uPtr(top)->SourceFileName(::STRINGS[4/*"Hamburger.ux"*/]);
    ...
    uPtr(mid)->SourceLineNumber(16);
    uPtr(mid)->SourceFileName(::STRINGS[4/*"Hamburger.ux"*/]);
    ...
    uPtr(bot)->SourceLineNumber(17);
    uPtr(bot)->SourceFileName(::STRINGS[4/*"Hamburger.ux"*/]);
