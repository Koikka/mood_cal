...
// /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/node_modules/@fuse-open/fuselibs/Source/build/Fuse.Controls/1.12.0/Control.Background.uno
// ------------------------------------------------------------------------------------------------------------------------------------------------
...
static void SolidRectangle_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(SolidRectangle, _draw_46d404b6), 0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(SolidRectangle, _draw_38768924), 0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(SolidRectangle, _draw_8010082d), 0,
...
void SolidRectangle::DrawElement(::g::Fuse::DrawContext* dc, ::g::Fuse::Elements::Element* element, ::g::Fuse::Drawing::Brush* brush, float opacity)
{
    ...
    if (uIs(brush, ::TYPES[0/*Fuse.Drawing.ImageFill*/]))
    {
        ...
        _draw_46d404b6.Const(1, DP_46d404b6_16_8_9.Texture == NULL);
        _draw_46d404b6.Use();
        ...
        _draw_46d404b6.Uniform12(16, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_46d404b6_4_9_5, element->WorldTransform()) : LocalTransform_46d404b6_4_9_5);
    ...
    else if (uIs(brush, ::TYPES[2/*Fuse.Drawing.SolidColor*/]))
    {
        ...
        _draw_38768924.Uniform12(3, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_38768924_4_9_2, uPtr(element)->WorldTransform()) : LocalTransform_38768924_4_9_2);
    ...
    else if (uIs(brush, ::TYPES[3/*Fuse.Drawing.LinearGradient*/]))
    {
        ...
        _draw_8010082d.Uniform12(6, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_8010082d_4_9_2, element->WorldTransform()) : LocalTransform_8010082d_4_9_2);
    ...
    else if (uIs(brush, ::TYPES[4/*Fuse.Drawing.StaticSolidColor*/]))
    {
        ...
        _draw_38768924.BlendDstRgb(3);
        _draw_38768924.Use();
        _draw_38768924.Attrib1(0, 2, DrawElement_VertexData_6e298326_7_2_1, 8, 0);
        _draw_38768924.Uniform12(1, ::g::Fuse::IRenderViewport::ViewProjectionTransform(uInterface(uPtr(dc->Viewport()), ::TYPES[1/*Fuse.IRenderViewport*/])));
        ...
        _draw_38768924.Uniform12(3, (element != NULL) ? ::g::Uno::Matrix::Mul8(LocalTransform_6e298326_4_9_2, uPtr(element)->WorldTransform()) : LocalTransform_6e298326_4_9_2);
        _draw_38768924.DrawArrays(6);
    }
}
...
{
    uArray* Vertices_46d404b6_7_1_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[5/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(0.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(1.0f, 0.0f));
    ...
    _draw_46d404b6 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControls_bundle::SolidRectangle9102669d());
    _draw_38768924 = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControls_bundle::SolidRectanglec0131986());
    _draw_8010082d = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New1(::g::FuseControls_bundle::SolidRectangle40bbf9dc());
}
