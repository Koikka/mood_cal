...
// internal sealed class DummyCameraView
// {
...
void DummyCameraView__SetCameraFocusPoint_fn(DummyCameraView* __this, double* x, double* y, int32_t* cameraWidth, int32_t* cameraHeight, int32_t* isFocusLocked, ::g::Uno::Threading::Future1** __retval);
