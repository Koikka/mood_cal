...
public class mood_calendar extends android.support.v7.app.AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback
{
//#if !#(LIBRARY:Defined)
