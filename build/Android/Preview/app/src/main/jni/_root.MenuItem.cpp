// This file was generated based on /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/build/Android/Preview/cache/ux14/MenuItem.g.uno.
...
static void MenuItem_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)MenuItem__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Panel_type* MenuItem_typeof()
{
    ...
    options.ObjectSize = sizeof(MenuItem);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("MenuItem", options);
    type->fp_build_ = MenuItem_build;
    type->fp_ctor_ = (void*)MenuItem__New4_fn;
    type->fp_cctor_ = MenuItem__cctor_4_fn;
...
// public MenuItem New() :8
void MenuItem__New4_fn(MenuItem** __retval)
{
    *__retval = MenuItem::New4();
}

// public MenuItem() [instance] :8
void MenuItem::ctor_7()
{
    uStackFrame __("MenuItem", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("MenuItem", "InitializeUX()");
...
// public MenuItem New() [static] :8
MenuItem* MenuItem::New4()
{
    MenuItem* obj1 = (MenuItem*)uNew(MenuItem_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
