...
static void ActivityUtils_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(3,
        new uFunction("add_Results", NULL, (void*)ActivityUtils__add_Results_fn, 0, true, uVoid_typeof(), 1, ::TYPES[2/*Uno.Action<int, int, Java.Object>*/]),
        new uFunction("remove_Results", NULL, (void*)ActivityUtils__remove_Results_fn, 0, true, uVoid_typeof(), 1, ::TYPES[2/*Uno.Action<int, int, Java.Object>*/]),
        new uFunction("StartActivity", NULL, (void*)ActivityUtils__StartActivity2_fn, 0, true, uVoid_typeof(), 3, ::g::Java::Object_typeof(), ::g::Android::ActivityResultCallback_typeof(), uObject_typeof()));
}
...
{
    uStackFrame __("Android.ActivityUtils", "OnReceived(int,int,Java.Object)");
    ActivityUtils_typeof()->Init();
    bool ret1;
    uDelegate* ret2;
    bool ret3;
...
{
    uStackFrame __("Android.ActivityUtils", "StartActivity(Java.Object,Android.ActivityResultCallback,object)");
    ActivityUtils_typeof()->Init();
...
{
    uStackFrame __("Android.ActivityUtils", "add_Results(Uno.Action<int, int, Java.Object>)");
    ActivityUtils_typeof()->Init();
...
{
    uStackFrame __("Android.ActivityUtils", "remove_Results(Uno.Action<int, int, Java.Object>)");
    ActivityUtils_typeof()->Init();
