...
// /usr/local/share/uno/Packages/Fuse.Models/1.8.1/ModelJavaScript.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Models/1.8.1/ZoneJS.uno
// ----------------------------------------------------------
...
::g::Fuse::Scripting::Module* ZoneJS::LoadModule()
{
    ...
    return ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseModels_bundle::zone9c742972()));
}
