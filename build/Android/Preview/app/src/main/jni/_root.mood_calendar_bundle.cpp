...
static void mood_calendar_bundle_build(uType* type)
{
    ...
    type->Reflection.SetFields(10,
        new uField("_12160064a", 0),
        new uField("_221600249", 1),
        new uField("_3215ffe48", 2),
        new uField("_4215ff94f", 3),
        new uField("_5215ff54e", 4),
        new uField("_6215ff14d", 5),
        new uField("_7215fed4c", 6),
        new uField("_821602c53", 7),
        new uField("_921602852", 8),
        new uField("main85dc14ca", 9));
}
