...
// /usr/local/share/uno/Packages/Fuse.Common/1.8.1/Internal/Cache.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.8.1/Internal/FuseConfig.uno
// ----------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.8.1/Internal/ImageContainer.uno");
