// This file was generated based on /Users/anttikoivisto/Documents/SAMK/FUSE/mood_calendar/build/Android/Preview/cache/ux14/Hamburger.g.uno.
...
static void Hamburger_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("get_IsOpen", NULL, (void*)Hamburger__get_IsOpen_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        new uFunction("set_IsOpen", NULL, (void*)Hamburger__set_IsOpen_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Bool_typeof()),
        new uFunction(".ctor", NULL, (void*)Hamburger__New4_fn, 0, true, type, 0),
        new uFunction("SetIsOpen", NULL, (void*)Hamburger__SetIsOpen_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Bool_typeof(), ::g::Uno::UX::IPropertyListener_typeof()));
}
...
{
    uStackFrame __("Hamburger", "InitializeUX()");
...
{
    uStackFrame __("Hamburger", "set_IsOpen(bool)");
...
{
    uStackFrame __("Hamburger", "SetIsOpen(bool,Uno.UX.IPropertyListener)");
