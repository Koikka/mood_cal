...
#include <Outracks.Simulator.Cl-42132196.h>
...
void Application::ResetEverything(bool initial)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[0/*"Failed to p...*/], e, this, ::STRINGS[1/*"/usr/local/...*/], 125, ::STRINGS[2/*"ResetEveryt...*/]);
    }
...
void Application::ShowDeveloperMenu()
{
    ...
    for (int32_t i = 0; i < uPtr(pointers)->Count(); i++)
        if (uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(pointers), uCRef<int32_t>(i), &ret9), ret9))->TryHardCapture(this, uDelegate::New(::TYPES[5/*Uno.Action*/], (void*)Application__DoNothing_fn, this), NULL))
            uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(pointers), uCRef<int32_t>(i), &ret10), ret10))->ReleaseCapture(this);
...
uObject* CppEvent::AddMethod()
{
    ...
    return ::g::Outracks::Simulator::Client::TryInvokeExtension::GetMethod(_declaringType, ::g::Outracks::Simulator::Bytecode::TypeMemberName::New1(::g::Uno::String::op_Addition2(::STRINGS[12/*"add_"*/], _name)), uArray::Init<uType*>(::TYPES[38/*Uno.Type[]*/], 1, (uType*)_type));
}
...
uObject* CppEvent::RemoveMethod()
{
    ...
    return ::g::Outracks::Simulator::Client::TryInvokeExtension::GetMethod(_declaringType, ::g::Outracks::Simulator::Bytecode::TypeMemberName::New1(::g::Uno::String::op_Addition2(::STRINGS[13/*"remove_"*/], _name)), uArray::Init<uType*>(::TYPES[38/*Uno.Type[]*/], 1, (uType*)_type));
}
...
uObject* CppProperty::GetMethod()
{
    ...
    return ::g::Outracks::Simulator::Client::TryInvokeExtension::GetMethod(_declaringType, ::g::Outracks::Simulator::Bytecode::TypeMemberName::New1(::g::Uno::String::op_Addition2(::STRINGS[14/*"get_"*/], _name)), uArray::New(::TYPES[38/*Uno.Type[]*/], 0));
}
...
uObject* CppProperty::SetMethod()
{
    ...
    return ::g::Outracks::Simulator::Client::TryInvokeExtension::GetMethod(_declaringType, ::g::Outracks::Simulator::Bytecode::TypeMemberName::New1(::g::Uno::String::op_Addition2(::STRINGS[15/*"set_"*/], _name)), uArray::Init<uType*>(::TYPES[38/*Uno.Type[]*/], 1, (uType*)_type));
}
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetGUID431", "()Ljava/lang/String;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetName432", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
void FailedToConnect::ctor_2(::g::Uno::Exception* exception)
{
    ...
    ctor_1(::STRINGS[19/*"Failed to c...*/], ::STRINGS[20/*"Please chec...*/], uPtr(exception)->Message(), uArray::Init< ::g::Outracks::Simulator::Client::DialogButton*>(::TYPES[37/*Outracks.Simulator.Client.DialogButton[]*/], 2, (::g::Outracks::Simulator::Client::DialogButton*)::g::Outracks::Simulator::Client::DialogButton::New1(::STRINGS[10/*"Change IP"*/], ::g::Outracks::Simulator::Client::ChangeIp::New1(::STRINGS[9/*""*/])), (::g::Outracks::Simulator::Client::DialogButton*)::g::Outracks::Simulator::Client::DialogButton::New1(::STRINGS[18/*"Try again"*/], ::g::Outracks::Simulator::Client::ConnectingToProxy::New1())));
}
...
static void FakeApp_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(FakeApp_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(FakeApp_type, interface5),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(FakeApp_type, interface6),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(FakeApp_type, interface7),
        ::g::Fuse::ITemplateSource_typeof(), offsetof(FakeApp_type, interface8),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(FakeApp_type, interface9),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(FakeApp_type, interface10),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(FakeApp_type, interface11),
        ::g::Fuse::Triggers::Actions::IShow_typeof(), offsetof(FakeApp_type, interface12),
        ::g::Fuse::Triggers::Actions::IHide_typeof(), offsetof(FakeApp_type, interface13),
        ::g::Fuse::Triggers::Actions::ICollapse_typeof(), offsetof(FakeApp_type, interface14),
        ::g::Fuse::IActualPlacement_typeof(), offsetof(FakeApp_type, interface15),
...
FakeApp_type* FakeApp_typeof()
{
    ...
    type->interface18.fp_get_Root = (void(*)(uObject*, ::g::Fuse::Visual**))FakeApp__FuseIRootVisualProviderget_Root_fn;
...
{
    ::STRINGS[21] = uString::Const("Oops! Something went wrong here.");
...
void Faulted::ctor_2(bool isOnline, ::g::Uno::Exception* exception, uArray* buttons)
{
    ...
    ctor_1(::STRINGS[21/*"Oops! Somet...*/], ::g::Uno::String::op_Addition2(uPtr(exception)->Message(), isOnline ? ::STRINGS[22/*"\n\nPlease ...*/] : ::STRINGS[9/*""*/]), ::STRINGS[9/*""*/], buttons);
}
...
{
    ::STRINGS[23] = uString::Const("Loading");
    ::STRINGS[24] = uString::Const("Starting project...");
    ::STRINGS[18] = uString::Const("Try again");
    ::TYPES[19] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[37] = ::g::Outracks::Simulator::Client::DialogButton_typeof()->Array();
    type->SetFields(1);
...
void Idle__OnEnterState_fn(Idle* __this, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    ::g::Outracks::Simulator::Client::LoadingScreen::Show(::g::Outracks::Simulator::Client::Context::App(), ::STRINGS[23/*"Loading"*/], ::STRINGS[24/*"Starting pr...*/]);
    return *__retval = __this, void();
}
...
{
    ::STRINGS[25] = uString::Const("Event '");
    ::STRINGS[26] = uString::Const(".");
    ::STRINGS[27] = uString::Const("' has no add method");
    ::STRINGS[28] = uString::Const("Property '");
    ::STRINGS[29] = uString::Const("' has no getter");
    ::STRINGS[30] = uString::Const(".ctor");
    ::STRINGS[31] = uString::Const("' has no remover method");
    ::STRINGS[32] = uString::Const("obj");
    ::STRINGS[33] = uString::Const("' has no setter");
    ...
    ::TYPES[52] = ::g::Outracks::Simulator::Client::IProperty_typeof();
    ::TYPES[53] = ::g::Uno::Reflection::IField_typeof();
    ::TYPES[7] = ::g::Uno::Exception_typeof();
    type->SetDependencies(
        ::g::Uno::Type_typeof());
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(14,
        ...
        new uFunction("CallDynamic", NULL, (void*)NativeReflection__CallDynamic_fn, 0, false, uObject_typeof(), 3, uObject_typeof(), ::g::Outracks::Simulator::Bytecode::TypeMemberName_typeof(), ::TYPES[32/*object[]*/]),
        new uFunction("CallStatic", NULL, (void*)NativeReflection__CallStatic_fn, 0, false, uObject_typeof(), 3, ::g::Outracks::Simulator::Bytecode::TypeName_typeof(), ::g::Outracks::Simulator::Bytecode::TypeMemberName_typeof(), ::TYPES[32/*object[]*/]),
        new uFunction("CreateDelegate", NULL, (void*)NativeReflection__CreateDelegate_fn, 0, false, uObject_typeof(), 4, ::g::Outracks::Simulator::Bytecode::TypeName_typeof(), uObject_typeof(), ::g::Outracks::Simulator::Bytecode::TypeMemberName_typeof(), ::TYPES[47/*Outracks.Optional<Outracks.Simulator.Bytecode.Signature>*/]),
        ...
        new uFunction("Instantiate", NULL, (void*)NativeReflection__Instantiate_fn, 0, false, uObject_typeof(), 2, ::g::Outracks::Simulator::Bytecode::TypeName_typeof(), ::TYPES[32/*object[]*/]),
...
// public NativeReflection(Outracks.Simulator.Client.ITypeMap typeMap) :100
...
// public NativeReflection New(Outracks.Simulator.Client.ITypeMap typeMap) :100
...
// private Outracks.Simulator.Client.IProperty ResolveProperty(object obj, Outracks.Simulator.Bytecode.TypeMemberName propertyName, Uno.Type propertyType) :125
...
// public NativeReflection(Outracks.Simulator.Client.ITypeMap typeMap) [instance] :100
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "AddEventHandler(object,Outracks.Simulator.Bytecode.TypeMemberName,object)");
    ...
    if (theEvent == NULL)
        U_THROW(::g::Outracks::Simulator::Runtime::MemberNotFound::New4(::g::Uno::Type::FullName(uPtr(type)), uPtr(member)->Name));
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "CallDynamic(object,Outracks.Simulator.Bytecode.TypeMemberName,object[])");
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "CallStatic(Outracks.Simulator.Bytecode.TypeName,Outracks.Simulator.Bytecode.TypeMemberName,object[])");
    uType* type = ::g::Outracks::Simulator::Client::ITypeMap::ResolveType1(uInterface(uPtr(_typeMap), ::TYPES[46/*Outracks.Simulator.Client.ITypeMap*/]), typeName);

    if (::g::Uno::Type::op_Equality(type, NULL))
        U_THROW(::g::Outracks::Simulator::Runtime::TypeNotFound::New4(uPtr(typeName)->FullName()));
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "CreateDelegate(Outracks.Simulator.Bytecode.TypeName,object,Outracks.Simulator.Bytecode.TypeMemberName,Outracks.Optional<Outracks.Simulator.Bytecode.Signature>)");
    uType* type = ::g::Uno::Object::GetType(uPtr(instance));
    uObject* method = methodSignature.HasValue(::TYPES[47/*Outracks.Optional<Outracks.Simulator.Bytecode.Signature>*/]) ? (uObject*)::g::Outracks::Simulator::Client::TryInvokeExtension::GetMethod(type, methodName, (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[48/*Uno.Collections.EnumerableExtensions.ToArray<Uno.Type>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[49/*Uno.Collections.EnumerableExtensions.Select<Outracks.Simulator.Bytecode.Parameter, Uno.Type>*/], (uObject*)uPtr(methodSignature.Value(::TYPES[47/*Outracks.Optional<Outracks.Simulator.Bytecode.Signature>*/]))->Parameters, uDelegate::New(::TYPES[50/*Uno.Func<Outracks.Simulator.Bytecode.Parameter, Uno.Type>*/], uInterface(uPtr(_typeMap), ::TYPES[46/*Outracks.Simulator.Client.ITypeMap*/]), offsetof(::g::Outracks::Simulator::Client::ITypeMap, fp_ResolveType))))) : (uObject*)::g::Outracks::Simulator::Client::TryInvokeExtension::GetMethod(type, methodName, uArray::New(::TYPES[38/*Uno.Type[]*/], 0));

    if (method == NULL)
        U_THROW(::g::Outracks::Simulator::Runtime::MemberNotFound::New4(::g::Uno::Type::FullName(uPtr(type)), uPtr(methodName)->Name));

    return ::g::Uno::Reflection::IFunction::CreateDelegate(uInterface(uPtr(method), ::TYPES[51/*Uno.Reflection.IFunction*/]), ::g::Outracks::Simulator::Client::ITypeMap::ResolveType1(uInterface(uPtr(_typeMap), ::TYPES[46/*Outracks.Simulator.Client.ITypeMap*/]), delegateTypeName), instance);
}
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "GetEnumValue(Outracks.Simulator.Bytecode.TypeName,Outracks.Simulator.Bytecode.TypeMemberName)");
    uType* type = ::g::Outracks::Simulator::Client::ITypeMap::ResolveType1(uInterface(uPtr(_typeMap), ::TYPES[46/*Outracks.Simulator.Client.ITypeMap*/]), enumType);
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "GetPropertyValue(object,Outracks.Simulator.Bytecode.TypeMemberName)");
    uObject* prop = ResolveProperty(obj, propertyName, NULL);
    uObject* getter = ::g::Outracks::Simulator::Client::IProperty::GetMethod(uInterface(uPtr(prop), ::TYPES[52/*Outracks.Simulator.Client.IProperty*/]));

    if (getter == NULL)
        U_THROW(::g::Uno::InvalidOperationException::New5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[28/*"Property '"*/], ::g::Outracks::Simulator::Client::IProperty::DeclaringType(uInterface(uPtr(prop), ::TYPES[52/*Outracks.Simulator.Client.IProperty*/]))), ::STRINGS[26/*"."*/]), propertyName), ::STRINGS[29/*"' has no ge...*/])));

    return ::g::Outracks::Simulator::Client::TryInvokeExtension::TryInvoke(::g::Outracks::Simulator::Client::IProperty::GetMethod(uInterface(prop, ::TYPES[52/*Outracks.Simulator.Client.IProperty*/])), obj, uArray::New(::TYPES[32/*object[]*/], 0));
}
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "GetStaticPropertyOrFieldValue(Outracks.Simulator.Bytecode.TypeName,Outracks.Simulator.Bytecode.TypeMemberName)");
    uType* type = ::g::Outracks::Simulator::Client::ITypeMap::ResolveType1(uInterface(uPtr(_typeMap), ::TYPES[46/*Outracks.Simulator.Client.ITypeMap*/]), typeName);
    ...
    if ((prop != NULL) && (::g::Outracks::Simulator::Client::IProperty::GetMethod(uInterface(uPtr(prop), ::TYPES[52/*Outracks.Simulator.Client.IProperty*/])) != NULL))
        return ::g::Uno::Reflection::IFunction::Invoke(uInterface(uPtr(::g::Outracks::Simulator::Client::IProperty::GetMethod(uInterface(uPtr(prop), ::TYPES[52/*Outracks.Simulator.Client.IProperty*/]))), ::TYPES[51/*Uno.Reflection.IFunction*/]), NULL, uArray::New(::TYPES[32/*object[]*/], 0));

    uObject* field = ::g::Outracks::Simulator::Client::TryInvokeExtension::GetField(type, memberName);

    if (field != NULL)
        return ::g::Uno::Reflection::IField::GetValue(uInterface(uPtr(field), ::TYPES[53/*Uno.Reflection.IField*/]), NULL);

    U_THROW(::g::Outracks::Simulator::Runtime::MemberNotFound::New4(uPtr(typeName)->FullName(), uPtr(memberName)->Name));
}
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "Instantiate(Outracks.Simulator.Bytecode.TypeName,object[])");
    return CallStatic(typeName, ::g::Outracks::Simulator::Bytecode::TypeMemberName::New1(::STRINGS[30/*".ctor"*/]), args);
}
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "IsSubtype(object,Outracks.Simulator.Bytecode.TypeName)");
    uType* type = ::g::Outracks::Simulator::Client::ITypeMap::ResolveType1(uInterface(uPtr(_typeMap), ::TYPES[46/*Outracks.Simulator.Client.ITypeMap*/]), typeName);
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "IsType(object,Outracks.Simulator.Bytecode.TypeName)");
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "RemoveEventHandler(object,Outracks.Simulator.Bytecode.TypeMemberName,object)");
    uType* type = ::g::Uno::Object::GetType(uPtr(instance));
    uObject* theEvent = ::g::Outracks::Simulator::Client::TryInvokeExtension::GetEvent(type, member, ::g::Uno::Object::GetType(uPtr(handlerDelegate)));
    ...
    if (remover == NULL)
        U_THROW(::g::Uno::InvalidOperationException::New5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[25/*"Event '"*/], ::g::Outracks::Simulator::Client::IEvent::DeclaringType(uInterface(uPtr(theEvent), ::TYPES[45/*Outracks.Simulator.Client.IEvent*/]))), ::STRINGS[26/*"."*/]), uPtr(member)->Name), ::STRINGS[31/*"' has no re...*/])));
...
// private Outracks.Simulator.Client.IProperty ResolveProperty(object obj, Outracks.Simulator.Bytecode.TypeMemberName propertyName, Uno.Type propertyType) [instance] :125
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "ResolveProperty(object,Outracks.Simulator.Bytecode.TypeMemberName,Uno.Type)");
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        U_THROW(::g::Outracks::Simulator::Runtime::MemberNotFound::New4(::g::Uno::Type::FullName(uPtr(objType)), uPtr(propertyName)->Name));
    }
}
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "SetPropertyValue(object,Outracks.Simulator.Bytecode.TypeMemberName,object)");
    uObject* prop = ResolveProperty(obj, propertyName, (value != NULL) ? (uType*)::g::Uno::Object::GetType(uPtr(value)) : NULL);
    uObject* setter = ::g::Outracks::Simulator::Client::IProperty::SetMethod(uInterface(uPtr(prop), ::TYPES[52/*Outracks.Simulator.Client.IProperty*/]));

    if (setter == NULL)
        U_THROW(::g::Uno::InvalidOperationException::New5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[28/*"Property '"*/], ::g::Outracks::Simulator::Client::IProperty::DeclaringType(uInterface(uPtr(prop), ::TYPES[52/*Outracks.Simulator.Client.IProperty*/]))), ::STRINGS[26/*"."*/]), propertyName), ::STRINGS[33/*"' has no se...*/])));
...
{
    uStackFrame __("Outracks.Simulator.Client.NativeReflection", "SetStaticField(Outracks.Simulator.Bytecode.TypeName,Outracks.Simulator.Bytecode.TypeMemberName,object)");
    uType* type = ::g::Outracks::Simulator::Client::ITypeMap::ResolveType1(uInterface(uPtr(_typeMap), ::TYPES[46/*Outracks.Simulator.Client.ITypeMap*/]), typeName);
    ...
    if (field == NULL)
        U_THROW(::g::Outracks::Simulator::Runtime::MemberNotFound::New4(uPtr(typeName)->FullName(), uPtr(fieldName)->Name));

    ::g::Uno::Reflection::IField::SetValue(uInterface(uPtr(field), ::TYPES[53/*Uno.Reflection.IField*/]), NULL, value);
}

// public NativeReflection New(Outracks.Simulator.Client.ITypeMap typeMap) [static] :100
...
{
    ReflectionCache::_functionCache_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[54/*Uno.Collections.Dictionary<Uno.Type, Uno.Reflection.CppFunction[]>*/]));
    ReflectionCache::_fieldCache_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[55/*Uno.Collections.Dictionary<Uno.Type, Uno.Reflection.CppField[]>*/]));
    ReflectionCache::_typeCache_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[56/*Uno.Collections.List<Uno.Collections.Dictionary<Outracks.Simulator.Bytecode.TypeName, Uno.Type>>*/]));
}

static void ReflectionCache_build(uType* type)
{
    ::TYPES[54] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), ::g::Uno::Reflection::CppFunction_typeof()->Array(), NULL);
    ::TYPES[55] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), ::g::Uno::Reflection::CppField_typeof()->Array(), NULL);
    ::TYPES[56] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::TypeName_typeof(), ::g::Uno::Type_typeof(), NULL), NULL);
    ::TYPES[57] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Reflection::CppField_typeof(), NULL);
    ::TYPES[58] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Reflection::CppField_typeof(), NULL);
    ::TYPES[59] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Reflection::CppFunction_typeof(), NULL);
    ::TYPES[60] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Reflection::CppFunction_typeof(), NULL);
    ::TYPES[61] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Outracks::Simulator::Bytecode::TypeName_typeof(), ::g::Uno::Type_typeof(), NULL), NULL);
    type->SetDependencies(
        ::g::Uno::Type_typeof());
    type->SetFields(0,
        ::TYPES[54/*Uno.Collections.Dictionary<Uno.Type, Uno.Reflection.CppFunction[]>*/], (uintptr_t)&ReflectionCache::_functionCache_, uFieldFlagsStatic,
        ::TYPES[55/*Uno.Collections.Dictionary<Uno.Type, Uno.Reflection.CppField[]>*/], (uintptr_t)&ReflectionCache::_fieldCache_, uFieldFlagsStatic,
        ::TYPES[56/*Uno.Collections.List<Uno.Collections.Dictionary<Outracks.Simulator.Bytecode.TypeName, Uno.Type>>*/], (uintptr_t)&ReflectionCache::_typeCache_, uFieldFlagsStatic);
}
...
uArray* ReflectionCache::GetFields(uType* type)
{
    ...
    ::g::Uno::Collections::List* fields = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[57/*Uno.Collections.List<Uno.Reflection.CppField>*/]);
    uType* t = type;

    while (::g::Uno::Type::op_Inequality(t, NULL))
    {
        uPtr(fields)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[58/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Uno.Reflection.CppField>*/], ::g::Uno::Reflection::CppReflection::GetFields(t))));
...
uArray* ReflectionCache::GetFunctions(uType* type)
{
    ...
    ::g::Uno::Collections::List* functions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[59/*Uno.Collections.List<Uno.Reflection.CppFunction>*/]);
    uType* t = type;

    while (::g::Uno::Type::op_Inequality(t, NULL))
    {
        uPtr(functions)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[60/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Uno.Reflection.CppFunction>*/], ::g::Uno::Reflection::CppReflection::GetFunctions(t))));
        t = ::g::Uno::Type::BaseType(uPtr(t));
    }
...
uType* ReflectionCache::GetType(::g::Outracks::Simulator::Bytecode::TypeName* typeName)
{
...

    {
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[61/*Uno.Collections.List<Uno.Collections.Dictionary<Outracks.Simulator.Bytecode.TypeName, Uno.Type>>.Enumerator*/]))
                {
                    ::g::Uno::Collections::Dictionary* dict = enum1.Current(::TYPES[61/*Uno.Collections.List<Uno.Collections.Dictionary<Outracks.Simulator.Bytecode.TypeName, Uno.Type>>.Enumerator*/]);
                    ...
                    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(dict), typeName, &ret7), ret7))
                    {
                        ...
                        enum1.Dispose(::TYPES[61/*Uno.Collections.List<Uno.Collections.Dictionary<Outracks.Simulator.Bytecode.TypeName, Uno.Type>>.Enumerator*/]);
                        return __uno_retval;
                    }
                }
            }
...
static void ReflectionExtensions__cctor__fn(uType* __type)
{
    ...
    ReflectionExtensions::ConstructorName_ = ::g::Outracks::Simulator::Bytecode::TypeMemberName::New1(::STRINGS[30/*".ctor"*/]);
}
...
uArray* ReflectionExtensions::FindFunctionsByName(uType* type, ::g::Outracks::Simulator::Bytecode::TypeMemberName* memberName)
{
    ...
    ::g::Uno::Collections::List* matchingFunctions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[59/*Uno.Collections.List<Uno.Reflection.CppFunction>*/]);
...
static void Running_build(uType* type)
{
    ...
    ::STRINGS[36] = uString::Const("/usr/local/share/uno/Packages/Fuse.Preview.Core/0.1.0/ApplicationStates.uno");
    ::TYPES[19] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[37] = ::g::Outracks::Simulator::Client::DialogButton_typeof()->Array();
    type->SetDependencies(
        ::g::Uno::Diagnostics::Debug_typeof(),
...
void Running__OnUpdate_fn(Running* __this, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log3(::STRINGS[35/*"Density cha...*/], 0, ::STRINGS[36/*"/usr/local/...*/], 379);
...
{
    ::STRINGS[37] = uString::Const("/usr/local/share/uno/Packages/Fuse.Preview.Core/0.1.0/ModalDialog.uno");
    ::TYPES[62] = ::g::Outracks::Optional_typeof()->MakeMethod(3/*Some<Outracks.Simulator.Client.DialogButton>*/, ::g::Outracks::Simulator::Client::DialogButton_typeof(), NULL);
    ::TYPES[63] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::Control_typeof(), NULL);
    ::TYPES[64] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(0/*Apply<Outracks.Simulator.Client.DialogButton>*/, ::g::Outracks::Simulator::Client::DialogButton_typeof(), NULL);
    ::TYPES[65] = ::g::Uno::Action1_typeof()->MakeType(::g::Outracks::Simulator::Client::DialogButton_typeof(), NULL);
    ::TYPES[66] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[67] = ::g::Outracks::Simulator::ForgetAction1_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Gestures::ClickedArgs_typeof(), NULL);
    ::TYPES[68] = ::g::Outracks::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Client::DialogButton_typeof(), NULL);
    type->SetDependencies(
        ::g::Uno::Diagnostics::Debug_typeof());
    type->SetFields(0,
        ...
        ::TYPES[68/*Outracks.Optional<Outracks.Simulator.Client.DialogButton>*/], (uintptr_t)0, uFieldFlagsConstrained);
}
...
void ShowingModalDialog__OnEnterState_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    uString* ind5;
    uDelegate* ret8;
    ::g::Uno::Collections::List* buttons = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[63/*Uno.Collections.List<Fuse.Controls.Control>*/]);
    ...
    for (array1 = __this->_buttons, index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        uDelegate* action = (::g::Outracks::Simulator::Closure__Apply_fn(::TYPES[64/*Outracks.Simulator.Closure.Apply<Outracks.Simulator.Client.DialogButton>*/], uDelegate::New(::TYPES[65/*Uno.Action<Outracks.Simulator.Client.DialogButton>*/], (void*)ShowingModalDialog__OnButtonClicked_fn, __this), button, &ret8), ret8);
        uDelegate* handler = uDelegate::New(::TYPES[66/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Outracks::Simulator::ForgetAction1__Execute_fn, (::g::Outracks::Simulator::ForgetAction1*)::g::Outracks::Simulator::ForgetAction1::New1(::TYPES[67/*Outracks.Simulator.ForgetAction<object, Fuse.Gestures.ClickedArgs>*/], action));
...
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log3(uPtr(e)->Message(), 0, ::STRINGS[37/*"/usr/local/...*/], 226);
    return *__retval = __this, void();
}
...
void ShowingModalDialog__OnUpdate_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    if (__this->_clickedButton().Value< ::g::Outracks::Optional1<uStrong< ::g::Outracks::Simulator::Client::DialogButton*> > >().HasValue(::TYPES[68/*Outracks.Optional<Outracks.Simulator.Client.DialogButton>*/]))
        return *__retval = uPtr(__this->_clickedButton().Value< ::g::Outracks::Optional1<uStrong< ::g::Outracks::Simulator::Client::DialogButton*> > >().Value(::TYPES[68/*Outracks.Optional<Outracks.Simulator.Client.DialogButton>*/]))->Destination, void();
...
void ShowingModalDialog::OnButtonClicked(::g::Outracks::Simulator::Client::DialogButton* button)
{
    ...
    _clickedButton().Value< ::g::Outracks::Optional1<uStrong< ::g::Outracks::Simulator::Client::DialogButton*> > >() = (::g::Outracks::Optional__Some_fn(::TYPES[62/*Outracks.Optional.Some<Outracks.Simulator.Client.DialogButton>*/], button, &ret7), ret7);
}
...
static void ShowingPrompt_build(uType* type)
{
    ...
    ::STRINGS[39] = uString::Const("Cancel");
    ::STRINGS[40] = uString::Const("# ");
    ::STRINGS[37] = uString::Const("/usr/local/share/uno/Packages/Fuse.Preview.Core/0.1.0/ModalDialog.uno");
    ::TYPES[66] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[69] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof(), NULL);
    ::TYPES[70] = ::g::Fuse::Controls::Control_typeof()->Array();
    type->SetDependencies(
        ::g::Uno::Diagnostics::Debug_typeof());
    type->SetFields(0,
...
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::Client::State** __retval)
{
    ...
    ind3;
    uPtr(collection1)->Text(::STRINGS[38/*"Ok"*/]);
    ::STRINGS[38/*"Ok"*/];
    ::g::Fuse::Controls::Button* ok = collection1;
    ::g::Fuse::Gestures::Clicked::AddHandler(ok, uDelegate::New(::TYPES[66/*Fuse.Gestures.ClickedHandler*/], (void*)ShowingPrompt__OnOkClicked_fn, __this));
    collection2 = ::g::Fuse::Controls::Button::New5();
    ind4 = ::g::Uno::Float4__New1(20.0f);
    uPtr(collection2)->Margin(ind4);
    ind4;
    uPtr(collection2)->Text(::STRINGS[39/*"Cancel"*/]);
    ::STRINGS[39/*"Cancel"*/];
    ::g::Fuse::Controls::Button* cancel = collection2;
    ::g::Fuse::Gestures::Clicked::AddHandler(cancel, uDelegate::New(::TYPES[66/*Fuse.Gestures.ClickedHandler*/], (void*)ShowingPrompt__OnCancelClicked_fn, __this));
    __this->_input = ::g::Fuse::Controls::TextBox::New4();
    ::g::Uno::Diagnostics::Debug::Log3(::g::Uno::String::op_Addition2(::STRINGS[40/*"# "*/], __this->_header), 0, ::STRINGS[37/*"/usr/local/...*/], 136);
    ::g::Uno::Diagnostics::Debug::Log3(__this->_body, 0, ::STRINGS[37/*"/usr/local/...*/], 137);
    ::g::Outracks::Simulator::Client::ModalDialog::ShowPrompt(::g::Outracks::Simulator::Client::Context::App(), __this->_header, __this->_body, __this->_input, (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[69/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Controls.Control>*/], uArray::Init< ::g::Fuse::Controls::Control*>(::TYPES[70/*Fuse.Controls.Control[]*/], 2, cancel, ok))));
    return *__retval = __this, void();
}
...
{
    ::STRINGS[41] = uString::Const("object");
    ::STRINGS[42] = uString::Const("string");
    ::STRINGS[43] = uString::Const("texture2D");
    ::STRINGS[44] = uString::Const("textureCube");
    ::STRINGS[45] = uString::Const("bool");
    ::STRINGS[46] = uString::Const("char");
    ::STRINGS[47] = uString::Const("byte");
    ::STRINGS[48] = uString::Const("byte2");
    ::STRINGS[49] = uString::Const("byte4");
    ::STRINGS[50] = uString::Const("sbyte");
    ::STRINGS[51] = uString::Const("sbyte2");
    ::STRINGS[52] = uString::Const("sbyte4");
    ::STRINGS[53] = uString::Const("short");
    ::STRINGS[54] = uString::Const("short2");
    ::STRINGS[55] = uString::Const("short4");
    ::STRINGS[56] = uString::Const("ushort");
    ::STRINGS[57] = uString::Const("ushort2");
    ::STRINGS[58] = uString::Const("ushort4");
    ::STRINGS[59] = uString::Const("int");
    ::STRINGS[60] = uString::Const("int2");
    ::STRINGS[61] = uString::Const("int3");
    ::STRINGS[62] = uString::Const("int4");
    ::STRINGS[63] = uString::Const("uint");
    ::STRINGS[64] = uString::Const("long");
    ::STRINGS[65] = uString::Const("ulong");
    ::STRINGS[66] = uString::Const("float");
    ::STRINGS[67] = uString::Const("float2");
    ::STRINGS[68] = uString::Const("float3");
    ::STRINGS[69] = uString::Const("float4");
    ::STRINGS[70] = uString::Const("float2x2");
    ::STRINGS[71] = uString::Const("float3x3");
    ::STRINGS[72] = uString::Const("float4x4");
    ::STRINGS[73] = uString::Const("double");
    ::STRINGS[74] = uString::Const("'");
    ::STRINGS[75] = uString::Const("' was not found");
    ...
    type->SetFields(0,
        ::TYPES[71/*Uno.Collections.Dictionary<string, Uno.Type>*/], offsetof(SimpleTypeMap, _builtins), 0);
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)SimpleTypeMap__New1_fn, 0, true, type, 0),
        new uFunction("ResolveType", NULL, (void*)SimpleTypeMap__ResolveType_fn, 0, false, ::TYPES[72/*Uno.Type*/], 1, ::g::Outracks::Simulator::Bytecode::Parameter_typeof()),
        new uFunction("ResolveType", NULL, (void*)SimpleTypeMap__ResolveType1_fn, 0, false, ::TYPES[72/*Uno.Type*/], 1, ::g::Outracks::Simulator::Bytecode::TypeName_typeof()));
}
...
void SimpleTypeMap::ctor_()
{
    ...
    _builtins = (collection1 = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[71/*Uno.Collections.Dictionary<string, Uno.Type>*/]), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[41/*"object"*/], uObject_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[42/*"string"*/], ::g::Uno::String_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[43/*"texture2D"*/], ::g::Uno::Graphics::Texture2D_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[44/*"textureCube"*/], ::g::Uno::Graphics::TextureCube_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[45/*"bool"*/], ::g::Uno::Bool_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[46/*"char"*/], ::g::Uno::Char_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[47/*"byte"*/], ::g::Uno::Byte_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[48/*"byte2"*/], ::g::Uno::Byte2_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[49/*"byte4"*/], ::g::Uno::Byte4_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[50/*"sbyte"*/], ::g::Uno::SByte_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[51/*"sbyte2"*/], ::g::Uno::SByte2_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[52/*"sbyte4"*/], ::g::Uno::SByte4_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[53/*"short"*/], ::g::Uno::Short_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[54/*"short2"*/], ::g::Uno::Short2_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[55/*"short4"*/], ::g::Uno::Short4_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[56/*"ushort"*/], ::g::Uno::UShort_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[57/*"ushort2"*/], ::g::Uno::UShort2_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[58/*"ushort4"*/], ::g::Uno::UShort4_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[59/*"int"*/], ::g::Uno::Int_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[60/*"int2"*/], ::g::Uno::Int2_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[61/*"int3"*/], ::g::Uno::Int3_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[62/*"int4"*/], ::g::Uno::Int4_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[63/*"uint"*/], ::g::Uno::UInt_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[64/*"long"*/], ::g::Uno::Long_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[65/*"ulong"*/], ::g::Uno::ULong_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[66/*"float"*/], ::g::Uno::Float_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[67/*"float2"*/], ::g::Uno::Float2_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[68/*"float3"*/], ::g::Uno::Float3_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[69/*"float4"*/], ::g::Uno::Float4_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[70/*"float2x2"*/], ::g::Uno::Float2x2_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[71/*"float3x3"*/], ::g::Uno::Float3x3_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[72/*"float4x4"*/], ::g::Uno::Float4x4_typeof()), ::g::Uno::Collections::Dictionary__Add_fn(uPtr(collection1), ::STRINGS[73/*"double"*/], ::g::Uno::Double_typeof()), collection1);
}
...
{
    uStackFrame __("Outracks.Simulator.Client.SimpleTypeMap", "ResolveType(Outracks.Simulator.Bytecode.Parameter)");
...
uType* SimpleTypeMap::ResolveType1(::g::Outracks::Simulator::Bytecode::TypeName* typeName)
{
    ...
    if (::g::Uno::Type::op_Equality(t, NULL) && !(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_builtins), typeName->FullName(), (void**)(&t), &ret3), ret3))
        U_THROW(::g::Uno::InvalidOperationException::New5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[74/*"'"*/], typeName), ::STRINGS[75/*"' was not f...*/])));

    if (typeName->IsParameterizedGenericType())
        t = ::g::Uno::Type::MakeGenericType(uPtr(t), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[48/*Uno.Collections.EnumerableExtensions.ToArray<Uno.Type>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[73/*Uno.Collections.EnumerableExtensions.Select<Outracks.Simulator.Bytecode.TypeName, Uno.Type>*/], (uObject*)uPtr(typeName)->GenericArgumentsRecursively(), uDelegate::New(::TYPES[74/*Uno.Func<Outracks.Simulator.Bytecode.TypeName, Uno.Type>*/], (void*)SimpleTypeMap__ResolveType1_fn, this))));

    if (::g::Uno::Type::ContainsGenericParameters(uPtr(t)))
        U_THROW(::g::Uno::InvalidOperationException::New5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[74/*"'"*/], typeName), ::STRINGS[76/*"' is not a ...*/])));
...
{
    ::TYPES[75] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Reflection::IFunction_typeof(), NULL);
    ::TYPES[51] = ::g::Uno::Reflection::IFunction_typeof();
    type->SetDependencies(
        ::g::Uno::Type_typeof());
}
...
// public static Outracks.Simulator.Client.IEvent GetEvent(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName name, Uno.Type propertyType) :366
...
// public static Outracks.Simulator.Client.IProperty GetProperty(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName name, Uno.Type propertyType) :353
...
{
    uStackFrame __("Outracks.Simulator.Client.TryInvokeExtension", "FindUnambiguousMethod(Uno.Type,Outracks.Simulator.Bytecode.TypeMemberName,object[])");
    uArray* array1;
    int32_t index2;
    int32_t length3;
    uObject* ret7;
    ::g::Uno::Collections::List* methods = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[75/*Uno.Collections.List<Uno.Reflection.IFunction>*/]);
    ...
    if (methods->Count() > 1)
        U_THROW(::g::Outracks::Simulator::Runtime::UnambiguousMethodNotFound::New4(::g::Uno::Type::FullName(uPtr(type)), uPtr(methodName)->Name));

    return (::g::Uno::Collections::List__get_Item_fn(methods, uCRef<int32_t>(0), &ret7), ret7);
}

// public static Outracks.Simulator.Client.IEvent GetEvent(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName name, Uno.Type propertyType) [static] :366
uObject* TryInvokeExtension::GetEvent(uType* type, ::g::Outracks::Simulator::Bytecode::TypeMemberName* name, uType* propertyType)
{
    uStackFrame __("Outracks.Simulator.Client.TryInvokeExtension", "GetEvent(Uno.Type,Outracks.Simulator.Bytecode.TypeMemberName,Uno.Type)");
    return (uObject*)::g::Outracks::Simulator::Client::CppEvent::New1(type, propertyType, uPtr(name)->Name);
}
...
{
    uStackFrame __("Outracks.Simulator.Client.TryInvokeExtension", "GetField(Uno.Type,Outracks.Simulator.Bytecode.TypeMemberName)");
...
{
    uStackFrame __("Outracks.Simulator.Client.TryInvokeExtension", "GetMethod(Uno.Type,Outracks.Simulator.Bytecode.TypeMemberName,Uno.Type[])");
    uArray* array4;
    int32_t index5;
    int32_t length6;
...
// public static Outracks.Simulator.Client.IProperty GetProperty(Uno.Type type, Outracks.Simulator.Bytecode.TypeMemberName name, Uno.Type propertyType) [static] :353
uObject* TryInvokeExtension::GetProperty(uType* type, ::g::Outracks::Simulator::Bytecode::TypeMemberName* name, uType* propertyType)
{
    uStackFrame __("Outracks.Simulator.Client.TryInvokeExtension", "GetProperty(Uno.Type,Outracks.Simulator.Bytecode.TypeMemberName,Uno.Type)");
    return (uObject*)::g::Outracks::Simulator::Client::CppProperty::New1(type, propertyType, uPtr(name)->Name);
}
...
bool TryInvokeExtension::ParametersMatch(uObject* m, uArray* arguments)
{
    ...
    uArray* prms = ::g::Uno::Reflection::IFunction::ParameterTypes(uInterface(uPtr(m), ::TYPES[51/*Uno.Reflection.IFunction*/]));
...
uObject* TryInvokeExtension::TryInvoke(uObject* mi, uObject* obj, uArray* value)
{
    ...
    return ::g::Uno::Reflection::IFunction::Invoke(uInterface(uPtr(mi), ::TYPES[51/*Uno.Reflection.IFunction*/]), obj, value);
}
// }
...
// /usr/local/share/uno/Packages/Fuse.Preview.Core/0.1.0/Reflection/UnoHostReflection.uno
// --------------------------------------------------------------------------------------

// public sealed class UnoHostReflection :13
// {
static void UnoHostReflection_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(13,
        ...
        new uFunction("CreateDelegate", NULL, (void*)UnoHostReflection__CreateDelegate_fn, 0, false, uObject_typeof(), 4, ::g::Outracks::Simulator::Bytecode::TypeName_typeof(), uObject_typeof(), ::g::Outracks::Simulator::Bytecode::TypeMemberName_typeof(), ::TYPES[47/*Outracks.Optional<Outracks.Simulator.Bytecode.Signature>*/]),
...
UnoHostReflection_type* UnoHostReflection_typeof()
{
    ...
    type = (UnoHostReflection_type*)uClassType::New("Outracks.Simulator.Client.UnoHostReflection", options);
...
// public generated UnoHostReflection() :13
void UnoHostReflection__ctor__fn(UnoHostReflection* __this)
{
    __this->ctor_();
}

// public void AddEventHandler(object instance, Outracks.Simulator.Bytecode.TypeMemberName member, object handlerDelegate) :39
...
// public object CallDynamic(object obj, Outracks.Simulator.Bytecode.TypeMemberName methodName, object[] arguments) :49
...
// public object CallStatic(Outracks.Simulator.Bytecode.TypeName typeName, Outracks.Simulator.Bytecode.TypeMemberName methodName, object[] arguments) :60
...
// public object CreateDelegate(Outracks.Simulator.Bytecode.TypeName delegateTypeName, object instance, Outracks.Simulator.Bytecode.TypeMemberName methodName, Outracks.Optional<Outracks.Simulator.Bytecode.Signature> methodSignature) :25
...
// public object GetEnumValue(Outracks.Simulator.Bytecode.TypeName enumType, Outracks.Simulator.Bytecode.TypeMemberName valueName) :80
...
// public object GetPropertyValue(object obj, Outracks.Simulator.Bytecode.TypeMemberName propertyName) :15
...
// public object GetStaticPropertyOrFieldValue(Outracks.Simulator.Bytecode.TypeName typeName, Outracks.Simulator.Bytecode.TypeMemberName memberName) :65
...
// public object Instantiate(Outracks.Simulator.Bytecode.TypeName typeName, object[] args) :55
...
// public bool IsSubtype(object obj, Outracks.Simulator.Bytecode.TypeName typeName) :70
...
// public bool IsType(object obj, Outracks.Simulator.Bytecode.TypeName typeName) :75
...
// public generated UnoHostReflection New() :13
void UnoHostReflection__New1_fn(UnoHostReflection** __retval)
{
    *__retval = UnoHostReflection::New1();
}

// private static string ParameterToTypeName(Outracks.Simulator.Bytecode.Parameter parameter) :34
...
// public void RemoveEventHandler(object instance, Outracks.Simulator.Bytecode.TypeMemberName member, object handlerDelegate) :44
...
// public void SetPropertyValue(object obj, Outracks.Simulator.Bytecode.TypeMemberName propertyName, object value) :20
...
// public generated UnoHostReflection() [instance] :13
void UnoHostReflection::ctor_()
{
}

// public void AddEventHandler(object instance, Outracks.Simulator.Bytecode.TypeMemberName member, object handlerDelegate) [instance] :39
...
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "AddEventHandler(object,Outracks.Simulator.Bytecode.TypeMemberName,object)");
    ::g::Outracks::UnoHost::Reflection::AddEventHandler(instance, uPtr(member)->Name, handlerDelegate);
}

// public object CallDynamic(object obj, Outracks.Simulator.Bytecode.TypeMemberName methodName, object[] arguments) [instance] :49
...
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "CallDynamic(object,Outracks.Simulator.Bytecode.TypeMemberName,object[])");
    return ::g::Outracks::UnoHost::Reflection::CallDynamic(obj, uPtr(methodName)->Name, arguments);
}

// public object CallStatic(Outracks.Simulator.Bytecode.TypeName typeName, Outracks.Simulator.Bytecode.TypeMemberName methodName, object[] arguments) [instance] :60
...
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "CallStatic(Outracks.Simulator.Bytecode.TypeName,Outracks.Simulator.Bytecode.TypeMemberName,object[])");
    return ::g::Outracks::UnoHost::Reflection::CallStatic(uPtr(typeName)->FullName(), uPtr(methodName)->Name, arguments);
}

// public object CreateDelegate(Outracks.Simulator.Bytecode.TypeName delegateTypeName, object instance, Outracks.Simulator.Bytecode.TypeMemberName methodName, Outracks.Optional<Outracks.Simulator.Bytecode.Signature> methodSignature) [instance] :25
...
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "CreateDelegate(Outracks.Simulator.Bytecode.TypeName,object,Outracks.Simulator.Bytecode.TypeMemberName,Outracks.Optional<Outracks.Simulator.Bytecode.Signature>)");
    uArray* argumentTypes = methodSignature.HasValue(::TYPES[47/*Outracks.Optional<Outracks.Simulator.Bytecode.Signature>*/]) ? (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[76/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[77/*Uno.Collections.EnumerableExtensions.Select<Outracks.Simulator.Bytecode.Parameter, string>*/], (uObject*)uPtr(methodSignature.Value(::TYPES[47/*Outracks.Optional<Outracks.Simulator.Bytecode.Signature>*/]))->Parameters, uDelegate::New(::TYPES[78/*Uno.Func<Outracks.Simulator.Bytecode.Parameter, string>*/], (void*)UnoHostReflection__ParameterToTypeName_fn))) : NULL;
...
// public object GetEnumValue(Outracks.Simulator.Bytecode.TypeName enumType, Outracks.Simulator.Bytecode.TypeMemberName valueName) [instance] :80
...
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "GetEnumValue(Outracks.Simulator.Bytecode.TypeName,Outracks.Simulator.Bytecode.TypeMemberName)");
    return ::g::Outracks::UnoHost::Reflection::GetEnumValue(uPtr(enumType)->FullName(), uPtr(valueName)->Name);
}

// public object GetPropertyValue(object obj, Outracks.Simulator.Bytecode.TypeMemberName propertyName) [instance] :15
uObject* UnoHostReflection::GetPropertyValue(uObject* obj, ::g::Outracks::Simulator::Bytecode::TypeMemberName* propertyName)
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "GetPropertyValue(object,Outracks.Simulator.Bytecode.TypeMemberName)");
    return ::g::Outracks::UnoHost::Reflection::GetPropertyValue(obj, uPtr(propertyName)->Name);
}

// public object GetStaticPropertyOrFieldValue(Outracks.Simulator.Bytecode.TypeName typeName, Outracks.Simulator.Bytecode.TypeMemberName memberName) [instance] :65
...
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "GetStaticPropertyOrFieldValue(Outracks.Simulator.Bytecode.TypeName,Outracks.Simulator.Bytecode.TypeMemberName)");
    return ::g::Outracks::UnoHost::Reflection::GetStaticPropertyOrFieldValue(uPtr(typeName)->FullName(), uPtr(memberName)->Name);
}

// public object Instantiate(Outracks.Simulator.Bytecode.TypeName typeName, object[] args) [instance] :55
uObject* UnoHostReflection::Instantiate(::g::Outracks::Simulator::Bytecode::TypeName* typeName, uArray* args)
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "Instantiate(Outracks.Simulator.Bytecode.TypeName,object[])");
    return ::g::Outracks::UnoHost::Reflection::Instantiate(uPtr(typeName)->FullName(), args);
}

// public bool IsSubtype(object obj, Outracks.Simulator.Bytecode.TypeName typeName) [instance] :70
bool UnoHostReflection::IsSubtype(uObject* obj, ::g::Outracks::Simulator::Bytecode::TypeName* typeName)
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "IsSubtype(object,Outracks.Simulator.Bytecode.TypeName)");
    return ::g::Outracks::UnoHost::Reflection::IsSubtype(obj, uPtr(typeName)->FullName());
}

// public bool IsType(object obj, Outracks.Simulator.Bytecode.TypeName typeName) [instance] :75
bool UnoHostReflection::IsType(uObject* obj, ::g::Outracks::Simulator::Bytecode::TypeName* typeName)
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "IsType(object,Outracks.Simulator.Bytecode.TypeName)");
    return ::g::Outracks::UnoHost::Reflection::IsType(obj, uPtr(typeName)->FullName());
}

// public void RemoveEventHandler(object instance, Outracks.Simulator.Bytecode.TypeMemberName member, object handlerDelegate) [instance] :44
...
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "RemoveEventHandler(object,Outracks.Simulator.Bytecode.TypeMemberName,object)");
    ::g::Outracks::UnoHost::Reflection::RemoveEventHandler(instance, uPtr(member)->Name, handlerDelegate);
}

// public void SetPropertyValue(object obj, Outracks.Simulator.Bytecode.TypeMemberName propertyName, object value) [instance] :20
...
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "SetPropertyValue(object,Outracks.Simulator.Bytecode.TypeMemberName,object)");
    ::g::Outracks::UnoHost::Reflection::SetPropertyValue(obj, uPtr(propertyName)->Name, value);
}

// public generated UnoHostReflection New() [static] :13
...
// private static string ParameterToTypeName(Outracks.Simulator.Bytecode.Parameter parameter) [static] :34
uString* UnoHostReflection::ParameterToTypeName(::g::Outracks::Simulator::Bytecode::Parameter* parameter)
{
    uStackFrame __("Outracks.Simulator.Client.UnoHostReflection", "ParameterToTypeName(Outracks.Simulator.Bytecode.Parameter)");
...
static void UserAppState_build(uType* type)
{
    ...
    ::TYPES[86] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[83/*Uno.Collections.ICollection`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL),
        ::TYPES[84/*Uno.Collections.IList`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    ...
    type->MethodTypes[2]->SetPrecalc(
        ::TYPES[83/*Uno.Collections.ICollection`1*/]->MakeType(type->MethodTypes[2]->U(0), NULL),
        ::TYPES[85/*Uno.Collections.IListExtensions*/]->MakeMethod(0/*AddRange<T>*/, type->MethodTypes[2]->U(0), NULL),
        ::TYPES[86/*Uno.Runtime.Implementation.Internal.ArrayEnumerable`1*/]->MakeType(type->MethodTypes[2]->U(0), NULL));
    type->SetFields(0,
...
void UserAppState::ApplyTo(::g::Outracks::Simulator::Client::FakeApp* app)
{
    ...
    UserAppState::SetIfNotEqual(::TYPES[79/*Outracks.Simulator.Client.UserAppState.SetIfNotEqual<Fuse.Node>*/], uPtr(app)->Children(), Children);
    UserAppState::SetIfNotEqual(::TYPES[80/*Outracks.Simulator.Client.UserAppState.SetIfNotEqual<Uno.UX.Resource>*/], app->Resources1(), Resources);
...
UserAppState* UserAppState::Save(::g::Outracks::Simulator::Client::FakeApp* app)
{
    ...
    return UserAppState::New1(uPtr(app)->Background1(), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[81/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], uPtr(app)->Children()), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[82/*Uno.Collections.EnumerableExtensions.ToArray<Uno.UX.Resource>*/], uPtr(app)->Resources1()), uPtr(app)->ClearColor());
}
...
{
    ::TYPES[87] = ::g::Outracks::Optional_typeof()->MakeMethod(0/*None<Outracks.Simulator.Runtime.Environment>*/, ::g::Outracks::Simulator::Runtime::Environment_typeof(), NULL);
    type->Reflection.SetFunctions(2,
...
uObject* VirtualMachine::Execute1(uObject* reflection, ::g::Outracks::Simulator::Bytecode::Lambda* lambda, uArray* arguments)
{
    ...
    return ::g::Outracks::Simulator::Runtime::ScopeClosure::New1(::g::Outracks::Simulator::Runtime::Environment::New1((::g::Outracks::Optional__None_fn(::TYPES[87/*Outracks.Optional.None<Outracks.Simulator.Runtime.Environment>*/], &ret1), ret1)), reflection)->Execute1(lambda, arguments);
}
// }
