...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.8.1/TextControls/FuseTextRenderer/LoadAsync.uno
// --------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.8.1/TextControls/FuseTextRenderer/CacheState.uno
// ---------------------------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.8.1/TextControls/FuseTextRenderer/FuseTextRenderer.uno
// ---------------------------------------------------------------------------------------------------------------
...
static void TextRenderer_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Primitives/1.8.1/TextControls/FuseTextRenderer/FuseTextRenderer.uno");
...
void TextRenderer::UpdateFont()
{
    ...
    int32_t newFontSize = ::g::Uno::Math::Clamp8((int32_t)::g::Uno::Math::Round2(uPtr(_control)->FontSize() * ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(uPtr(_control)->Viewport()), ::TYPES[2/*Fuse.ICommonViewport*/]))), 4, 400);
