...
// internal sealed class mood_calendar_FuseControlsPanel_Color_Property :65
// {
...
// public mood_calendar_FuseControlsPanel_Color_Property(Fuse.Controls.Panel obj, Uno.UX.Selector name) :68
...
// public override sealed float4 Get(Uno.UX.PropertyObject obj) :70
...
{
    uStackFrame __("mood_calendar_FuseControlsPanel_Color_Property", "Get(Uno.UX.PropertyObject)");
    return *__retval = uPtr(uCast< ::g::Fuse::Controls::Panel*>(obj, ::TYPES[0/*Fuse.Controls.Panel*/]))->Color(), void();
}

// public mood_calendar_FuseControlsPanel_Color_Property New(Fuse.Controls.Panel obj, Uno.UX.Selector name) :68
...
// public override sealed void Set(Uno.UX.PropertyObject obj, float4 v, Uno.UX.IPropertyListener origin) :71
...
{
    uStackFrame __("mood_calendar_FuseControlsPanel_Color_Property", "Set(Uno.UX.PropertyObject,float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
// public mood_calendar_FuseControlsPanel_Color_Property(Fuse.Controls.Panel obj, Uno.UX.Selector name) [instance] :68
...
// public mood_calendar_FuseControlsPanel_Color_Property New(Fuse.Controls.Panel obj, Uno.UX.Selector name) [static] :68
