...
// /usr/local/share/uno/Packages/Fuse.Elements/1.8.1/Element.UnoHostInterface.uno
// ------------------------------------------------------------------------------
...
static void Element_build(uType* type)
{
    ...
    type->Reflection.SetFields(2,
        new uField("DefaultTransformOrigin", 109),
        new uField("ExplicitTransformOriginName", 110));
...
static void ElementBatch_build(uType* type)
{
    ...
    ::TYPES[12] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*Select<Fuse.Elements.ElementBatchEntry, Fuse.Visual>*/, ::g::Fuse::Elements::ElementBatchEntry_typeof(), ::g::Fuse::Visual_typeof(), NULL);
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.8.1/LayoutMasterAttr.uno
// ----------------------------------------------------------------------
...
static void Viewport_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::TYPES[36/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(Viewport_type, interface10),
...
Viewport_type* Viewport_typeof()
{
    ...
    type->interface19.fp_get_ViewTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))Viewport__FuseICommonViewportget_ViewTransform_fn;
