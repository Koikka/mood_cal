...
static void Permissions__Android_build(uType* type)
{
    type->Reflection.SetFunctions(4,
        new uFunction("get_CAMERA", NULL, (void*)Permissions__Android__get_CAMERA_fn, 0, true, ::g::Uno::Permissions::PlatformPermission_typeof(), 0),
        ...
        new uFunction("get_RECORD_AUDIO", NULL, (void*)Permissions__Android__get_RECORD_AUDIO_fn, 0, true, ::g::Uno::Permissions::PlatformPermission_typeof(), 0),
...
// public static Uno.Permissions.PlatformPermission get_RECORD_AUDIO() :228
void Permissions__Android__get_RECORD_AUDIO_fn(::g::Uno::Permissions::PlatformPermission* __retval)
{
    *__retval = Permissions__Android::RECORD_AUDIO();
}
...
// public static Uno.Permissions.PlatformPermission get_RECORD_AUDIO() [static] :228
::g::Uno::Permissions::PlatformPermission Permissions__Android::RECORD_AUDIO()
{
    return ::g::Uno::Permissions::Internal::Android::_record_audio();
}
