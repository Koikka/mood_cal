...
static void VideoTools_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)VideoTools__New2_fn, 0, true, type, 0));
}
...
{
    uStackFrame __("Fuse.VideoTools.VideoTools", ".ctor()");
    ctor_1();
...
{
    uStackFrame __("Fuse.VideoTools.VideoTools", "CopyVideoToCameraRoll(Fuse.Scripting.Context,object[])");
