...
// /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Messages/BuildIssueDetected.cs
// ------------------------------------------------------------------------------------------------
...
void BuildIssueDetected__ToString_fn(BuildIssueDetected* __this, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::String::Format(::STRINGS[1/*"{0}: {1} {2...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 4, (uString*)::g::Outracks::Simulator::SourceReferenceCanonicalization::ToCanonicalForm(__this->Source()), uBox<int32_t>(::g::Outracks::Simulator::BuildIssueType_typeof(), __this->Severity()), (uString*)__this->Code(), (uString*)__this->Message())), void();
}
...
void BuildIssueDetected::ctor_1(int32_t type, uString* code, uString* message, ::g::Outracks::Optional1<uStrong< ::g::Outracks::Simulator::SourceReference*> > source, ::g::Uno::Guid buildId)
{
    BuildId(buildId);
    Severity(type);
    Code(code);
...
BuildIssueDetected* BuildIssueDetected::New2(int32_t type, uString* code, uString* message, ::g::Outracks::Optional1<uStrong< ::g::Outracks::Simulator::SourceReference*> > source, ::g::Uno::Guid buildId)
{
...
BuildIssueDetected* BuildIssueDetected::ReadDataFrom(::g::System::IO::BinaryReader* reader)
{
    ...
    ind2;
    ind3 = uUnbox<int32_t>(::g::Outracks::Simulator::BuildIssueType_typeof(), ::g::Uno::Enum::Parse(::g::Outracks::Simulator::BuildIssueType_typeof(), uPtr(reader)->ReadString()));
...
// /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Messages/BuildLogged.cs
// -----------------------------------------------------------------------------------------
...
void BuildLogged__ctor_1_fn(BuildLogged* __this, uString* text, ::g::Outracks::Optional1<int32_t>* color, ::g::Uno::Guid* buildId)
{
...
void BuildLogged__get_Color_fn(BuildLogged* __this, ::g::Outracks::Optional1<int32_t>* __retval)
{
    *__retval = __this->Color();
}

// private generated void set_Color(Outracks.Optional<Outracks.Simulator.ConsoleColor> value) :26
void BuildLogged__set_Color_fn(BuildLogged* __this, ::g::Outracks::Optional1<int32_t>* value)
{
    __this->Color(*value);
}
...
void BuildLogged__New2_fn(uString* text, ::g::Outracks::Optional1<int32_t>* color, ::g::Uno::Guid* buildId, BuildLogged** __retval)
{
...
void BuildLogged::ctor_1(uString* text, ::g::Outracks::Optional1<int32_t> color, ::g::Uno::Guid buildId)
{
    BuildId(buildId);
    Text(text);
    Color(color);
...
::g::Outracks::Optional1<int32_t> BuildLogged::Color()
{
    return _Color().Value< ::g::Outracks::Optional1<int32_t> >();
}

// private generated void set_Color(Outracks.Optional<Outracks.Simulator.ConsoleColor> value) [instance] :26
void BuildLogged::Color(::g::Outracks::Optional1<int32_t> value)
{
    _Color().Value< ::g::Outracks::Optional1<int32_t> >() = value;
}
...
BuildLogged* BuildLogged::New2(uString* text, ::g::Outracks::Optional1<int32_t> color, ::g::Uno::Guid buildId)
{
...
// /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Concurrency/ConcurrentQueue.cs
// ------------------------------------------------------------------------------------------------
...
static void GetSimulatorEndpoint_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("SUCCESS");
    ::STRINGS[16] = uString::Const("Failed to request host.");
    ::STRINGS[17] = uString::Const("Call Tom Curise");
    ...
    {
        {
                                        ...
                                        {
                                            {
                                                ...
                                                writer->Write6(::g::Uno::String::Join(::STRINGS[13/*" "*/], defines));
                                                uString* initialState = uPtr(reader)->ReadString();

                                                if (::g::Uno::String::Equals2(uPtr<uString*>(::STRINGS[14/*"DESIGNER_NO...*/]), initialState))
                                                    U_THROW(::g::Outracks::Simulator::DesignerNotRunning::New4());

                                                if (::g::Uno::String::Equals2(uPtr<uString*>(::STRINGS[15/*"SUCCESS"*/]), initialState) == false)
                                                    U_THROW(::g::Uno::Exception::New2(::STRINGS[16/*"Failed to r...*/]));
            ...
            U_THROW(::g::Uno::Exception::New2(::STRINGS[17/*"Call Tom Cu...*/]));
        }
    }
...
void ImmutableList__ToString_fn(ImmutableList* __this, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[18/*"["*/], ::g::Outracks::Simulator::StringSplitting::JoinToString(__types[0], (uObject*)__this, ::STRINGS[19/*", "*/])), ::STRINGS[20/*"]"*/]), void();
}
...
uString* IndentString::Indent(uString* str)
{
    ...
    return ::g::Outracks::Simulator::StringSplitting::Join((uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[44/*Uno.Collections.EnumerableExtensions.Select<string, string>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[45/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], ::g::Uno::String::Split(uPtr(str), uArray::Init<int32_t>(::TYPES[46/*char[]*/], 1, 10)))), uDelegate::New(::TYPES[47/*Uno.Func<string, string>*/], (void*)IndentString__PrefixWithTab_fn)), ::STRINGS[21/*"\n"*/]);
}
...
uString* IndentString::PrefixWithTab(uString* s)
{
    ...
    return ::g::Uno::String::op_Addition2(::STRINGS[22/*"\t"*/], s);
}
// }

// /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Exceptions/Exceptions.cs
// ------------------------------------------------------------------------------------------
...
static void LineNumber_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("LineNumber must be >= 1");
    ::TYPES[4] = ::g::Uno::Int_typeof();
    type->SetFields(0,
...
void LineNumber::ctor_(int32_t line)
{
    ...
    if (line <= 0)
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New7(::STRINGS[23/*"line"*/], ::STRINGS[24/*"LineNumber ...*/]));
...
{
    ObjectIdentifier::None_ = ObjectIdentifier::New2(::STRINGS[25/*"N/A"*/], 0);
}

static void ObjectIdentifier_build(uType* type)
{
    ::STRINGS[25] = uString::Const("N/A");
...
void ObjectIdentifier::ctor_1(uString* document, int32_t tagIndex)
{
    ...
    _string = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(document, ::STRINGS[26/*"#"*/]), uBox<int32_t>(::TYPES[4/*int*/], tagIndex));
    Document = document;
}
...
{
    ::STRINGS[27] = uString::Const("/usr/local/share/uno/Packages/Fuse.Preview.Core/0.1.0/SimulatorClient.uno");
    ::TYPES[52] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::IBinaryMessage_typeof(), NULL);
...
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log3(uPtr(e)->Message(), 0, ::STRINGS[27/*"/usr/local/...*/], 246);
    }
}
...
uString* SourceReferenceCanonicalization::ToCanonicalForm(::g::Outracks::Optional1<uStrong< ::g::Outracks::Simulator::SourceReference*> > src)
{
    ...
    return src.HasValue(::TYPES[68/*Outracks.Optional<Outracks.Simulator.SourceReference>*/]) ? (uString*)SourceReferenceCanonicalization::ToCanonicalForm1(src.Value(::TYPES[68/*Outracks.Optional<Outracks.Simulator.SourceReference>*/])) : ::STRINGS[28/*"?"*/];
}
...
uString* SourceReferenceCanonicalization::ToCanonicalForm2(::g::Outracks::Simulator::TextPosition pos)
{
    ...
    return ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition(uBox(::TYPES[76/*Outracks.Simulator.LineNumber*/], pos.Line), ::STRINGS[32/*","*/]), uBox(::TYPES[77/*Outracks.Simulator.CharacterNumber*/], pos.Character));
}
// }
...
// /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Concurrency/Tasks.cs
// --------------------------------------------------------------------------------------
...
void TextOffset__ToString_fn(TextOffset* __this, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::String::op_Addition1(::STRINGS[33/*"@"*/], uBox<int32_t>(::TYPES[4/*int*/], __this->_offset)), void();
}
...
::g::Outracks::Simulator::TextOffset* TextOffsetConversion::ToOffset(::g::Outracks::Simulator::TextPosition pos, uString* data)
{
    ...
    uArray* lines = ::g::Uno::String::Split(uPtr(data), uArray::Init<int32_t>(::TYPES[46/*char[]*/], 1, 10));
    ...
    for (int32_t i = 0; i < (::g::Outracks::Simulator::LineNumber__op_Implicit(pos.Line) - 1); ++i)
        sizeOfDataBefore = sizeOfDataBefore + (uPtr(::g::Uno::String::Replace1(uPtr(uPtr(lines)->Strong<uString*>(i)), ::STRINGS[34/*"\r"*/], ::STRINGS[31/*""*/]))->Length() + 1);

    uString* line = ::g::Uno::String::Replace1(uPtr(uPtr(lines)->Strong<uString*>(::g::Outracks::Simulator::LineNumber__op_Implicit(pos.Line) - 1)), ::STRINGS[34/*"\r"*/], ::STRINGS[31/*""*/]);
...
::g::Outracks::Simulator::TextPosition TextOffsetConversion::ToPosition(::g::Outracks::Simulator::TextOffset* offset, uString* data)
{
    ...
    uArray* lines = ::g::Uno::String::Split(uPtr(::g::Uno::String::Replace1(uPtr(data), ::STRINGS[34/*"\r"*/], ::STRINGS[31/*""*/])), uArray::Init<int32_t>(::TYPES[46/*char[]*/], 1, 10));
...
void TextPosition__ToString_fn(TextPosition* __this, uType* __type, uString** __retval)
{
    ...
    return *__retval = ::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition(uBox(::TYPES[76/*Outracks.Simulator.LineNumber*/], __this->Line), ::STRINGS[35/*":"*/]), uBox(::TYPES[77/*Outracks.Simulator.CharacterNumber*/], __this->Character)), void();
}
        ...
        {
            {
                while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[24/*Uno.Collections.IEnumerator*/])))
                {
                    ...
                    s = ::g::Uno::String::op_Addition2(s, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[36/*"    "*/], uPtr(e)->Message()), ::STRINGS[21/*"\n"*/]));
                }
            }
        }
