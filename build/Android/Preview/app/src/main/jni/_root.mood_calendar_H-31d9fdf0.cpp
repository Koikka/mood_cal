...
{
    uStackFrame __("mood_calendar_Hamburger_IsOpen_Property", "Get(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("mood_calendar_Hamburger_IsOpen_Property", "Set(Uno.UX.PropertyObject,bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
