...
{
    uStackFrame __("mood_calendar_accessor_Hamburger_IsOpen", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("mood_calendar_accessor_Hamburger_IsOpen", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
