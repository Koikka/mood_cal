...
static void Android_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("android.permission.RECORD_AUDIO");
...
// internal static extern Uno.Permissions.PlatformPermission _record_audio() :543
void Android___record_audio_fn(::g::Uno::Permissions::PlatformPermission* __retval)
{
    *__retval = Android::_record_audio();
}
...
// internal static extern Uno.Permissions.PlatformPermission _record_audio() [static] :543
::g::Uno::Permissions::PlatformPermission Android::_record_audio()
{
