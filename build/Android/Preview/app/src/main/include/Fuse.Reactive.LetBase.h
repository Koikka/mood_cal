// This file was generated based on /usr/local/share/uno/Packages/Fuse.Reactive.Bindings/1.8.1/Let.uno.
...
{
    ::g::Fuse::Node__ISiblingDataProvider interface6;
    ::g::Fuse::IObject interface7;
