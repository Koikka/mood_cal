// This file was generated based on /usr/local/share/uno/Packages/Outracks.Simulator.Common.Uno/0.0.0/Messages/BuildLogged.cs.
...
struct BuildLogged : uObject
{
    ...
    void ctor_();
    void ctor_1(uString* text, ::g::Outracks::Optional1<int32_t> color, ::g::Uno::Guid buildId);
    ::g::Uno::Guid BuildId();
    void BuildId(::g::Uno::Guid value);
    ::g::Outracks::Optional1<int32_t> Color();
    void Color(::g::Outracks::Optional1<int32_t> value);
    uString* Text();
    void Text(uString* value);
    uString* Type();
    void WriteDataTo(::g::System::IO::BinaryWriter* writer);
    static BuildLogged* New1();
    static BuildLogged* New2(uString* text, ::g::Outracks::Optional1<int32_t> color, ::g::Uno::Guid buildId);
