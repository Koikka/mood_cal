...
{
    void(*fp_GetPhotoHandle)(::g::Fuse::Controls::Photo*, ::g::Uno::Threading::Future1**);
...
{
    void ctor_();
    ::g::Uno::Threading::Future1* GetPhotoHandle() { ::g::Uno::Threading::Future1* __retval; return (((Photo_type*)__type)->fp_GetPhotoHandle)(this, &__retval), __retval; }
