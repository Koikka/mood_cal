// This file was generated based on /usr/local/share/uno/Packages/Fuse.Elements/1.8.1/Resources/Exif/Exif.uno.
...
struct ExifAndroidImpl : uObject
{
    ...
    static ::g::Fuse::Resources::Exif::ExifData FromInputStream(::g::Java::Object* stream);
